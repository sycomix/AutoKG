...
def main() -> None:
    ...
    print(f"{Fore.RED}Original task prompt:\n{task}\n")
    print(f"{Fore.GREEN}Specified task prompt:\n{specified_task}\n")
    ...
    while n < chat_turn_limit:
        ...
        print(f"{Fore.BLUE}AI User ({user_role_name}):\n\n{user_msg.content}\n\n")
        ...
        if Supplement_info != "" or "Agent Stoped" not in Supplement_info:
            ...
            print(
                f"{Fore.YELLOW}AI Assistant With Tool ({assistant_role_name}):\n\n{assistant_msg.content}\n\n"
            )
            ...
            assistant_msg = HumanMessage(content=assistant_ai_msg.content)
            print(
                f"{Fore.CYAN}AI Assistant ({assistant_role_name}):\n\n{assistant_msg.content}\n\n"
            )
